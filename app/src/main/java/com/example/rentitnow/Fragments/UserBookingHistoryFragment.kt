 ...
 * Use the [UserBookingHistoryFragment.newInstance] factory method to
...
class UserBookingHistoryFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment UserBookingHistoryFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            UserBookingHistoryFragment().apply {
