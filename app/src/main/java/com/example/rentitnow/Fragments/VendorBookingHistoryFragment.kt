 ...
 * Use the [VendorBookingHistoryFragment.newInstance] factory method to
...
class VendorBookingHistoryFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment VendorBookingHistoryFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            VendorBookingHistoryFragment().apply {
